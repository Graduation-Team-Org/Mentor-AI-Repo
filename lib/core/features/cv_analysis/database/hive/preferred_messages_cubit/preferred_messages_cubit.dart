...
class AnalyzeResumePreferredMessagesCubit extends Cubit<PreferredAnalyzeResumeMessagesState> {
  AnalyzeResumePreferredMessagesCubit() : super(PreferredAnalyzeResumeMessagesInitial()) {
  ...
  Future<void> addPrefrredMessages(PreferredMessagesModel prefrredMessage) async {
    try {
      ...
      emit(PreferredAnalyzeResumeMessagesSuccsess());
    } catch (e) {
      emit(
        PreferredAnalyzeResumeMessagesFailure(errorMessage: e.toString()),
      );
    }
  }
