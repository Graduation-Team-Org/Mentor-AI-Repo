...
class _PreffredMessagesViewState extends State<PreffredMessagesView> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: BlocBuilder<GetAllAnalyzeResumePreferredMessagesCubit, GetAllAnalyzeResumePreferredMessagesCubitState>(
        builder: (context, state) {
          final List<PreferredAnalyzeResumeMessagesModel> messages =
              BlocProvider.of<GetAllAnalyzeResumePreferredMessagesCubit>(context)
                  .preferredMessages ?? [];
