...
class _RoadmapScreenState extends State<RoadmapPage>
        ...
        children: [
          if (from != 'User')
            Padding(
              ...
              child: CircleAvatar(
                radius: 15,
                backgroundImage: AssetImage('image/home1.png'),
              ),
            ),
          Expanded(
            child: Column(
                        ...
                        child: SlideTransition(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 5),
                              Text(
                                "Let’s find your best learning path!",
                                style: TextStyle(
                                  fontSize: 14,
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                SizedBox(width: 10),
                                Text("Steve", style: TextStyle(color: Colors.white, fontSize: 18)),
                              ],
                            ),
                            SizedBox(height: 20),
                            TextField(
